...
import cImag from '/public/images/shape/1.svg'
import cImag2 from '/public/images/shape/2.svg'
import cImag3 from '/public/images/shape/3.svg'
import cImag4 from '/public/images/shape/4.svg'
...
const CategorySection2 = (props) => {
    return (
        <section className={`wpo-courses-section-s2 section-padding ${props.cClass}`}>
            ...
            <div className="shape-3"><Image src={cImag3} alt="" /></div>
            <div className="shape-4"><Image src={cImag4} alt="" /></div>
        </section>
    );
}
